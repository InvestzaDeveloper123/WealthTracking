    ...
    >
        ...
        <div className="footer-left">
          ...
          <div className="footer-section-block">
            ...
            <div
              ...
              onClick={() =>
                window.open("https://share.google/k2xmco9Omr9Ljij1V", "_blank")
              }
            >
              <div className="map-placeholder">
                ...
                <div className="map-overlay">
                  <span className="map-link-text">View larger map</span>
                </div>
              </div>
            </div>
          </div>
      ...
      >
        ...
        <div className="footer-end-bottom">
          <div className="footer-end-bottom-container">
            {/* Left - Tagline & Social */}
            <div className="footer-bottom-left">
              <h4 className="footer-tagline">Your wealth partner</h4>
              ...
              <div className="footer-copyright">
                <p>
                  Copyright © Investza | All Rights Reserved |{" "}
            ...
            <div className="footer-bottom-center">
              ...
              <ul className="footer-links">
                ...
                <li>
                  <a href="/wealth-tracker">Wealth Tracker</a>
                </li>
                <li>
                  <a href="/team">Team</a>
                </li>
