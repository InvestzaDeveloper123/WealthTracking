...
//                   src={item.img}
//                   alt={`slide-${i}`}
//                   className="rounded-3xl shadow-2xl transition-transform duration-1200 ease-out group-hover:scale-105  w-40        /* default for mobile */
//     sm:w-52     /* ≥640px */
//     md:w-64     /* ≥768px */
//     lg:w-80     /* ≥1024px */
//     xl:w-96     /* ≥1280px */"
...
//               <p className="text-base sm:text-lg md:text-xl leading-relaxed bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 bg-clip-text text-transparent">
//                 {item.text}
//               </p>

//               <button className="px-4 py-2 sm:px-6 sm:py-3 rounded-full text-white text-sm sm:text-base font-semibold cursor-pointer border-none bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 hover:opacity-90 transition-opacity duration-300">
//                 Review My Portfolio →
//               </button>
//             </div>
//           </div>
